...
public class vntana_apertura_caja extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel12.setText(" S/.:");
        pnel_inf.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 136, 20, 20));
        ...
        btn_agregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/on.png"))); // NOI18N
        ...
        pnel_inf.add(btn_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 110, -1));

        btn_cancelar.setBackground(new java.awt.Color(204, 51, 0));
        btn_cancelar.setForeground(new java.awt.Color(255, 255, 255));
        btn_cancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/off.png"))); // NOI18N
        ...
        pnel_inf.add(btn_cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 180, -1, -1));
        ...
        //  if (isActiva()) {    
            if (form_validado()) {
                if (isActiva()) {
                    ...
                    apc.setFecha_hora_aper(txtFecha.getText());
