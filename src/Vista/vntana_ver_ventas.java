...
public class vntana_ver_ventas extends javax.swing.JDialog {
    ...
    public vntana_ver_ventas(java.awt.Frame parent, boolean modal) {
        ...
        loadPermisos(ced);
        bloquearColumTable(rv.show_vnta_date(text_fec.getText(), text_fec.getText()));
        countVntas();
    }
    ...
    private void initComponents() {
        ...
        pnel_cab2.setBackground(new java.awt.Color(244, 236, 225));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, -1, 20));
        ...
        jPanel1.add(txtFec1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 100, -1));

        jLabel13.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel13.setText("Fecha Fin:");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 10, -1, 20));
        ...
        jPanel1.add(txtFec2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, 100, -1));

        btn_busc.setBackground(new java.awt.Color(0, 153, 204));
        btn_busc.setForeground(new java.awt.Color(255, 255, 255));
        btn_busc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/search.png"))); // NOI18N
        ...
        jPanel1.add(btn_busc, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 10, 100, -1));

        btn_all.setBackground(new java.awt.Color(204, 51, 0));
        btn_all.setForeground(new java.awt.Color(255, 255, 255));
        btn_all.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/todo.png"))); // NOI18N
        ...
        jPanel1.add(btn_all, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 10, 90, -1));

        jLabel10.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel10.setText("Cantidad de Ventas:");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 10, -1, 20));

        lblCount.setText("0");
        jPanel1.add(lblCount, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 10, 20, 20));

        jLabel11.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel11.setText("Fecha Actual:");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, 20));

        text_fec.setText("--");
        jPanel1.add(text_fec, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 90, 20));
        ...
        btn_impr.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/impri.png"))); // NOI18N
