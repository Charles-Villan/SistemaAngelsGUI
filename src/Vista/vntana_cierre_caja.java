...
public class vntana_cierre_caja extends javax.swing.JDialog {
    ...
    public void cerrarCaja() {
        ...
        rc.update_aper_caja(id_aper_caja, fecfin.getText(), Double.parseDouble(txtmontofinal.getText()), false);
    ...
    private void initComponents() {
        ...
        cmbCaja = new javax.swing.JComboBox<caja>();
        ...
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 20, -1, 20));

        jLabel22.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel22.setText("Ingresos:");
        jPanel2.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 20, -1, 20));

        txtingresos.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtingresos.setEnabled(false);
        jPanel2.add(txtingresos, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 20, 80, -1));

        txtegresos.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtegresos.setEnabled(false);
        jPanel2.add(txtegresos, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 20, 80, -1));

        jButton2.setBackground(new java.awt.Color(204, 51, 0));
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/cance.png"))); // NOI18N
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 6, 140, 40));

        btn_guardar.setBackground(new java.awt.Color(0, 153, 204));
        btn_guardar.setForeground(new java.awt.Color(255, 255, 255));
        btn_guardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/cajaregistra.png"))); // NOI18N
        ...
        jPanel2.add(btn_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 6, -1, 40));
