...
public class vntana_productos extends javax.swing.JDialog {
 ...
 /*   public boolean esEdit() {
    ...
    private void initComponents() {
        ...
        panel_all.setBackground(new java.awt.Color(244, 236, 225));
        panel_all.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText("Seleccionar dando doble clic");
        panel_all.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 160, -1));
        ...
        getContentPane().add(panel_all, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 530, 950, 40));
        ...
        getContentPane().add(pnl_cab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, -1));

        jToolBar1.setBackground(new java.awt.Color(244, 236, 225));
        jToolBar1.setRollover(true);

        btn_new.setBackground(new java.awt.Color(244, 236, 225));
        btn_new.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/new2.png"))); // NOI18N
        ...
        btn_agregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/save.png"))); // NOI18N
        ...
        bnt_cancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/clean.png"))); // NOI18N
        ...
        btn_delete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/delete2.png"))); // NOI18N
        ...
        btn_load.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/refresh2.png"))); // NOI18N
        ...
        btn_ivntario.setBackground(new java.awt.Color(244, 236, 225));
        btn_ivntario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/inventario.png"))); // NOI18N
        ...
        getContentPane().add(jToolBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 950, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 930, 190));

        pnel_inf1.setBackground(new java.awt.Color(244, 236, 225));
        ...
        pnel_inf1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 10, -1, 30));

        jButton3.setBackground(new java.awt.Color(204, 51, 0));
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/todo.png"))); // NOI18N
        ...
        pnel_inf1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 10, 90, 30));

        getContentPane().add(pnel_inf1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 930, 50));
        ...
        pnel_inf.add(text_color, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 810, -1));
        ...
        lblprec_cmpra.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        lblprec_vnta.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        getContentPane().add(pnel_inf, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 930, 180));
